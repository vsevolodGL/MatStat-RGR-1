...
#### <p>Эмпирическая функция распределения F<sub>n</sub>(X<sub>1</sub>)</p>

![ecdf\_x1](plots/x1_ecdf.png)

#### <p>Эмпирическая функция распределения F<sub>n</sub>(X<sub>2</sub>)</p>

![ecdf\_x2](plots/x2_ecdf.png)

#### <p>Эмпирическая функция распределения F<sub>n</sub>(X<sub>3</sub>)</p>

![ecdf\_x3](plots/x3_ecdf.png)
...
* точный интервал для μ
* точный интервал для σ²
